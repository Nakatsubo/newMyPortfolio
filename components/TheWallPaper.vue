<template>
  <div id="wallPaper-wrapper" class="wallPaper-wrapper">
    <svg width="1688" height="1769" xmlns="http://www.w3.org/2000/svg" class="wallPaper-wrapper__path wallPaper-wrapper__path--01">
    ...
    <svg width="2145" height="2248" xmlns="http://www.w3.org/2000/svg" class="wallPaper-wrapper__path wallPaper-wrapper__path--02">
      <path d="M1000.7 354.3C1317.8 153 1682.9 41.6 2091.7 1l53.3 33.3c-51.9 12.3-90.2 2.8-297.5 50.9-207.3 48-369 94.7-542.9 207.8-258.5 178.1-361.9 438.7-70.8 871.4 184.4 248.4 199.4 508.7 33.7 774.6-185.6 297.7-623.7 408.4-953 202.8C17 1956.1-93.7 1517.7 91.9 1220c122-219.6 253.3-477.2 908.8-865.7z" stroke-width=".5" fill="none" fill-rule="evenodd"></path>
    </svg>
  </div>
</template>
...
.wallPaper-wrapper {
  ...
  &__path {
    ...
    &--01 {
      ...
      margin-bottom: -300px;
      margin-right: -400px;
      animation: wallPaper01 20s infinite alternate linear;
    }
    ...
    &--02 {
      ...
      animation: wallPaper02 20s infinite alternate linear;
    }
